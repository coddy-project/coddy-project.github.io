...
| `docs/<slug>/index.html` | Redirect page of every documentation page (generated by `make site-docs` in coddy-agent from `docs/nav.yaml`); sends a person to the page on GitHub, keeps the fragment |
| `docs/<slug>.md` | The Markdown of the page for agents and scripts, published unchanged from the coddy-agent repository (image links absolute) |
| `llms.txt`, `llms-full.txt` | The documentation index and the concatenated pages for agents that read documentation; generated with the twins |
