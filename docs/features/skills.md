...
![Settings, Skills tab: the resolved skills.dirs, remote sources and installed skills](https://raw.githubusercontent.com/coddy-project/coddy-agent/main/docs/assets/screenshot-fullhd-settings-skills.png)
