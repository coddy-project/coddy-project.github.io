...
![Settings, Subagents tab: definitions by scope, project files awaiting trust](https://raw.githubusercontent.com/coddy-project/coddy-agent/main/docs/assets/subagents/settings-subagents-dark.png)

*Settings, Subagents tab: definitions by scope, project files awaiting trust*

![The spawn_agent tool card in the transcript](https://raw.githubusercontent.com/coddy-project/coddy-agent/main/docs/assets/subagents/spawn-agent-card-dark-1280.png)
...
![The finished run with its report](https://raw.githubusercontent.com/coddy-project/coddy-agent/main/docs/assets/subagents/tasks-detail-agent-finished-dark.png)

*The finished run with its report*

![The child session opened read-only from the task row](https://raw.githubusercontent.com/coddy-project/coddy-agent/main/docs/assets/subagents/child-transcript-readonly-dark.png)
