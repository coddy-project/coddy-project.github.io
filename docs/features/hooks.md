...
| Dark | Light |
|---|---|
| ![Held hooks file notice, dark](https://raw.githubusercontent.com/coddy-project/coddy-agent/main/docs/assets/screenshot-hooks-notice-dark.png) | ![Held hooks file notice, light](https://raw.githubusercontent.com/coddy-project/coddy-agent/main/docs/assets/screenshot-hooks-notice-light.png) |
