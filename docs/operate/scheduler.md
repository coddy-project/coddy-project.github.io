...
![The scheduler drawer with three jobs, one paused](https://raw.githubusercontent.com/coddy-project/coddy-agent/main/docs/assets/screenshot-fullhd-scheduler.png)

*The scheduler drawer with three jobs, one paused*

![The job editor: cron hint, mode and model, the markdown body](https://raw.githubusercontent.com/coddy-project/coddy-agent/main/docs/assets/screenshot-fullhd-scheduler-job.png)
