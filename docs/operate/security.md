...
![A project-local MCP server awaiting approval in Settings](https://raw.githubusercontent.com/coddy-project/coddy-agent/main/docs/assets/screenshot-fullhd-settings-mcp.png)
