...
A four-minute recording of a relay, two nodes and the aggregated session list, in the console and in the browser, is [swarm.mp4](https://raw.githubusercontent.com/coddy-project/coddy-agent/main/docs/assets/video/swarm.mp4) (GitHub plays it on the file page).
...
![The topology graph with a live relay](https://raw.githubusercontent.com/coddy-project/coddy-agent/main/docs/assets/swarm/map-live-dark-1280.png)

*The topology graph with a live relay*

![A mounted node and its sessions](https://raw.githubusercontent.com/coddy-project/coddy-agent/main/docs/assets/swarm/node-dark-1280.png)

*A mounted node and its sessions*

![A permission prompt relayed through two relays](https://raw.githubusercontent.com/coddy-project/coddy-agent/main/docs/assets/swarm/permission-two-relays-dark-1280.png)

*A permission prompt relayed through two relays*

![A relay that needs a token before it lists anything](https://raw.githubusercontent.com/coddy-project/coddy-agent/main/docs/assets/swarm/relay-needs-token-dark-1280.png)
