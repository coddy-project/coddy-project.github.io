...
[`internal/tooling/tool.go`](https://github.com/coddy-project/coddy-agent/blob/main/internal/tooling/tool.go):
...
func executeFetchURL(ctx context.Context, argsJSON string, _ *Env) (string, error) {
    args, err := parseArgs[fetchURLArgs](https://github.com/coddy-project/coddy-agent/blob/main/docs/contributing/argsJSON)
    if err != nil {
        return "", err
    }
...
func executeGitLog(ctx context.Context, argsJSON string, env *Env) (string, error) {
    args, err := parseArgs[gitLogArgs](https://github.com/coddy-project/coddy-agent/blob/main/docs/contributing/argsJSON)
    if err != nil {
        return "", err
    }
